...
INSERT INTO oidc_client VALUES('web','web','ownCloud web',replace('ownCloud web\n','\n',char(10)),'devidp','["https:\/\/ocis.owncloud.test\/","https:\/\/ocis.owncloud.test\/oidc-callback.html","https:\/\/ocis.owncloud.test\/oidc-silent-redirect.html"]','["openid","profile","email"]',1,0);
